...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.DesaWisataSumpu.b4xfloattextfield");
            if (htSubs == null) {
...
public b4a.DesaWisataSumpu.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((b4a.DesaWisataSumpu.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(b4a.DesaWisataSumpu.b4xfloattextfield _field) throws Exception{
...
_mnexttextfield = (b4a.DesaWisataSumpu.b4xfloattextfield)(_o);
...
public ResumableSub_SwitchFromPasswordToRegular(b4a.DesaWisataSumpu.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((b4a.DesaWisataSumpu.b4xfloattextfield)(this)) == false) { 
