...
public class b4xsignaturetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.DesaWisataSumpu.b4xsignaturetemplate");
            if (htSubs == null) {
...
public String  _show(b4a.DesaWisataSumpu.b4xdialog _dialog) throws Exception{
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((b4a.DesaWisataSumpu.b4xdialog) args[0]);
