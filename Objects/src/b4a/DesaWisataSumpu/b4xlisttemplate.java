...
public class b4xlisttemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.DesaWisataSumpu.b4xlisttemplate");
            if (htSubs == null) {
...
public ResumableSub_Show(b4a.DesaWisataSumpu.b4xlisttemplate parent,b4a.DesaWisataSumpu.b4xdialog _dialog) {
this.parent = parent;
