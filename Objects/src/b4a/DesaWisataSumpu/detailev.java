...
public class detailev extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.DesaWisataSumpu", "b4a.DesaWisataSumpu.detailev");
...
anywheresoftware.b4a.keywords.Common.LogImpl("45505025","DetailEV loaded",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("45636097","Going back to previous activity",0);
