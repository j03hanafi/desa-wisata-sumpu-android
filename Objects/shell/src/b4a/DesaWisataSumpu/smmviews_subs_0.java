...
try {
		Debug.PushSubsStack("AddMedia (smmviews) ","smmviews",14,__ref.getField(false, "ba"),__ref,47);
...
try {
		Debug.PushSubsStack("CancelRequest (smmviews) ","smmviews",14,__ref.getField(false, "ba"),__ref,40);
...
try {
		Debug.PushSubsStack("CreateSMMView (smmviews) ","smmviews",14,__ref.getField(false, "ba"),__ref,345);
...
try {
		Debug.PushSubsStack("GetView (smmviews) ","smmviews",14,__ref.getField(false, "ba"),__ref,225);
...
try {
		Debug.PushSubsStack("Initialize (smmviews) ","smmviews",14,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("MediaToBitmap (smmviews) ","smmviews",14,__ref.getField(false, "ba"),__ref,133);
...
try {
		Debug.PushSubsStack("MediaTypeToViewType (smmviews) ","smmviews",14,__ref.getField(false, "ba"),__ref,162);
...
Debug.JustUpdateDeviceLine();
smmviews.__c.runVoidMethod ("LogImpl","912451858",RemoteObject.concat(RemoteObject.createImmutable("Unexpected media type: "),_mediatype),0);
...
try {
		Debug.PushSubsStack("MimeToMediaType (smmviews) ","smmviews",14,__ref.getField(false, "ba"),__ref,143);
...
smmviews.__c.runVoidMethod ("LogImpl","912386306",RemoteObject.createImmutable("*** Add a reference to B4XGIfView and add SMM_GIF to the build configuration ***"),0);};
...
smmviews.__c.runVoidMethod ("LogImpl","912386309",RemoteObject.createImmutable("*** Add a reference to WebP library and add SMM_WEBP to the build configuration ***"),0);};
...
smmviews.__c.runVoidMethod ("LogImpl","912386314",RemoteObject.createImmutable("*** Add a reference to the video library and add SMM_VIDEO to the build configuration ***"),0);};
...
try {
		Debug.PushSubsStack("ParentResized (smmviews) ","smmviews",14,__ref.getField(false, "ba"),__ref,311);
...
try {
		Debug.PushSubsStack("ReturnViewToCache (smmviews) ","smmviews",14,__ref.getField(false, "ba"),__ref,185);
...
try {
		Debug.PushSubsStack("TypeToString (smmviews) ","smmviews",14,__ref.getField(false, "ba"),__ref,294);
