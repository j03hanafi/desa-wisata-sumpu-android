...
try {
		Debug.PushSubsStack("Activity_Create (listev) ","listev",10,listev.mostCurrent.activityBA,listev.mostCurrent,37);
...
try {
		Debug.PushSubsStack("Activity_Pause (listev) ","listev",10,listev.mostCurrent.activityBA,listev.mostCurrent,61);
...
try {
		Debug.PushSubsStack("Activity_Resume (listev) ","listev",10,listev.mostCurrent.activityBA,listev.mostCurrent,55);
...
listev.mostCurrent.__c.runVoidMethod ("LogImpl","56881281",RemoteObject.createImmutable("ListEV loaded"),0);
...
try {
		Debug.PushSubsStack("BtnBack_Click (listev) ","listev",10,listev.mostCurrent.activityBA,listev.mostCurrent,65);
...
Debug.ShouldStop(2);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","57012353",RemoteObject.createImmutable("Going back to previous activity"),0);
...
try {
		Debug.PushSubsStack("btnRefresh_Click (listev) ","listev",10,listev.mostCurrent.activityBA,listev.mostCurrent,144);
...
Debug.ShouldStop(65536);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","57340033",RemoteObject.createImmutable("Refreshing ListEV..."),0);
...
try {
		Debug.PushSubsStack("CLV_ItemClick (listev) ","listev",10,listev.mostCurrent.activityBA,listev.mostCurrent,70);
...
try {
		Debug.PushSubsStack("CreateItem (listev) ","listev",10,listev.mostCurrent.activityBA,listev.mostCurrent,89);
...
try {
		Debug.PushSubsStack("DownloadImg (listev) ","listev",10,listev.mostCurrent.activityBA,listev.mostCurrent,151);
...
Debug.ShouldStop(67108864);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","57405572",RemoteObject.concat(RemoteObject.createImmutable("Getting "),_imagemap.runMethod(false,"GetValueAt",(Object)(BA.numberCast(int.class, _i))),RemoteObject.createImmutable("@"),_imagemap.runMethod(false,"GetKeyAt",(Object)(BA.numberCast(int.class, _i)))),0);
...
try {
		Debug.PushSubsStack("JobDone (listev) ","listev",10,listev.mostCurrent.activityBA,listev.mostCurrent,104);
...
Debug.ShouldStop(256);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","57274497",RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job.getField(true,"_jobname" /*RemoteObject*/ ),RemoteObject.createImmutable(", Success = "),_job.getField(true,"_success" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(512);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","57274530",BA.ObjectToString(listev.mostCurrent.__c.runMethod(false,"LastException",listev.mostCurrent.activityBA)),0);
 };
 break; }
}
;
...
try {
		Debug.PushSubsStack("PanelListItem_Click (listev) ","listev",10,listev.mostCurrent.activityBA,listev.mostCurrent,74);
...
Debug.ShouldStop(1048576);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","57143435",RemoteObject.createImmutable("Redirect to DetailEV Activity"),0);
